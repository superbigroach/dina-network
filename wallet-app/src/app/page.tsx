    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4">
      <div className="w-full max-w-sm flex flex-col items-center gap-8">
        ...
        <div className="w-full flex flex-col gap-3">
          <Link
            href="/dashboard"
            className="w-full py-3 px-4 rounded-xl bg-white text-slate-950 font-semibold text-center flex items-center justify-center gap-3 hover:bg-slate-100 transition-colors"
          >
          ...
          <Link
            href="/dashboard"
            className="w-full py-3 px-4 rounded-xl bg-slate-900 border border-slate-700 text-white font-semibold text-center flex items-center justify-center gap-3 hover:bg-slate-800 transition-colors"
          >
